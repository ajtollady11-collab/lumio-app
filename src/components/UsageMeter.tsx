...
export function UsageMeter() {
  ...
  if (!loaded || !data) {
    return (
      <div className="rounded-3xl border border-[var(--line-2)] bg-white p-5" style={{ boxShadow: "var(--shadow-sm)" }}>
        <div className="h-3 w-20 animate-pulse rounded bg-paper-2" />
        <div className="mt-3 h-2 w-full animate-pulse rounded bg-paper-2" />
        <div className="mt-2 h-2 w-3/4 animate-pulse rounded bg-paper-2" />
      </div>
    );
  }
